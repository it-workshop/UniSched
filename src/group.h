...
#define _GROUP_H_
    ...
    class Group {
    private:
        unsigned long long int id_;			/**< Group's identificator in the database. */
        string name_;					/**< Group's name. */
        string description_;				/**< Group's description. */
        vector<struct Group_Content_*> people_;		/**< People in this group. */
        Calendar *calendar_;				/**< Group's calendar. */

    public:
        Group(unsigned long long int id, string name, string description);
							/**< Constructor.
							 * @param [in] id Group's identificator in the database.
							 * @param [in] name Group's name.
							 * @param [in] description Group's description.
							 */
        Group(unsigned long long int id, Group * group);/**< Constructor.
							 * @param [in] id Group's identificator in the database.
        ...
        string get_name();				/**< Get group's name.
							 * @return Group's name. */
        unsigned long long get_id();			/**< Get group's identificator.
        ...
        vector<struct Group_Content_*> *get_people();
							/**< Get group's people.
