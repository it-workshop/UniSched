...
* WITH_SQLITE(Y) Собирать бэкэнд к базе данных sqlite3 (необходимо наличие в системе библиотеки и заголовков).
...
* WITH_YAML(Y) Собирать бэкэнд FileStorage, использующий библиотеку yaml-cpp.
