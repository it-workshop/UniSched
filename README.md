...
"человек", "группа людей" и "событие". С максимально возмоной независимостью от
того, что находится снизу и сверху от ядра системы (вид хранения данных и
интерфейс). Ничего ценного или полезного данный код не делает.
...
Подготовить проект к сборке с поддержкой sqlite
    ...
    +--------------+------------+------------------------------------------------------+
    | WITH_CLI     |    N       | Собирать интерфейс коммандной строки (в разработке)  |
    +--------------+------------+------------------------------------------------------+
    | WITH_YAML    |    Y       | Собирать бэкэнд к yaml файлам (требуется yaml-cpp    |
    |              |            | версии 0.5.0).                                       |
    +--------------+------------+------------------------------------------------------+
