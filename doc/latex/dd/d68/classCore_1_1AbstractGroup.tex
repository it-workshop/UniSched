...
\hypertarget{classCore_1_1AbstractGroup_abf219d714e6a17d5e712b2fcb60395d2}{
...
\subsubsection[{add\_\-child}]{\setlength{\rightskip}{0pt plus 5cm}void Core::AbstractGroup::add\_\-child (
\begin{DoxyParamCaption}
\item[{{\bf AbstractGroup} $\ast$}]{group}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily  \mbox{[}inline, protected\mbox{]}}}}
\label{dd/d68/classCore_1_1AbstractGroup_abf219d714e6a17d5e712b2fcb60395d2}
...
\hline
\end{DoxyParams}
This method does not controlls that group in not a child already. This check must be in function Group::add\_\-parent(). That function must be only the one place where this caled from. \hypertarget{classCore_1_1AbstractGroup_acbc75be98b4a9b9ceab55967124c0351}{
...
\label{dd/d68/classCore_1_1AbstractGroup_acbc75be98b4a9b9ceab55967124c0351}
...
\hline
\end{DoxyParams}
Do not use this directly. It must be moved into protected or private. This method called from update method. \hypertarget{classCore_1_1AbstractGroup_aa81866b9c414c24d25ca26311b4b4330}{
...
\hline
\end{DoxyParams}
This method looks for requested group and deletes it. Group::del\_\-parent() must be only the one place where this method called from. \hypertarget{classCore_1_1AbstractGroup_a378e2ab0f4db0a47906c4341846a143b}{
...
\hline
\end{DoxyParams}
Do not use this directly. It must be moved into protected or private. This method called from update method. \hypertarget{classCore_1_1AbstractGroup_ace41b51dd585a95b61990b69f078a283}{
...
src/core/\hyperlink{abstractgroup_8cpp}{abstractgroup.cpp}\item 
