...
\item[\mbox{\tt[in]} {\em id}]Person's identificator. \item[\mbox{\tt[in]} {\em name}]Person's name. \item[\mbox{\tt[in]} {\em surname}]Person's surname. \item[\mbox{\tt[in]} {\em sex}]Person's sex. \item[\mbox{\tt[in]} {\em birthday}]Person's birthday. \end{DoxyParams}
