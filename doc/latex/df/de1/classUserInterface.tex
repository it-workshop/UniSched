...
\begin{DoxyParams}{Parameters}
\item[\mbox{\tt[in]} {\em time}]Formated string. \end{DoxyParams}
...
\index{UserInterface@{UserInterface}!requests@{requests}}
\index{requests@{requests}!UserInterface@{UserInterface}}
